...
describe("flattenStyle", () => {
  ...
  it("should recursively flatten arrays", () => {
    ...
    const flatStyle = flattenStyle([null, [] as any, [style1, style2], style3]);
  ...
  // Skip: tests RN's internal style registry IDs which we don't have
  it.skip("should ignore invalid class names", () => {
