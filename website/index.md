...
pass counts do not define vitest-native capability or fidelity. A change is reduced into a minimal
package-owned test before it is classified. See the [validation model](/guide/validation-model).
